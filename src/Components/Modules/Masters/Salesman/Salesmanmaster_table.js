...
import './Salesmanmaster_table.css';

import baseURL from '../../../../Url/NodeBaseURL';

const Salesmanmaster_table = () => {
  ...
  const handleEdit = (id) => {
    navigate(`/salesman/${id}`);
  };

  const handleCreate = () => {
    navigate('/salesman'); // Navigate to the /customermaster page
  };
...
export default Salesmanmaster_table;
