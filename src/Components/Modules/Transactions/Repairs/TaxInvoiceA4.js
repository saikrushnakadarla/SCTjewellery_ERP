                        ...
                        <Page size="A4" style={styles.page}>
                                ...
                                <View style={styles.row}>
                                        ...
                                        <View style={[styles.column, { marginTop: 0, width: "20%", marginLeft: 20, fontFamily: "Times-Bold" }]}>
                                                ...
                                                <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 5 }}>
                                                        <Text>STAFF:</Text>
                                                        <Text style={{ textAlign: "right", flex: 1 }}>Manikanta Jewels</Text>
                                                </View>

                                                {/* GSTIN */}
                                                <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 5 }}>
                                                        <Text>GSTIN:</Text>
                                                        <Text style={{ textAlign: "right", flex: 1 }}>29EXQPP3451K1ZN</Text>
                                                </View>
                                        </View>
                                </View>
                                ...
                                <View style={styles.container}>
                                        {/* Centered Heading */}
                                        <Text style={[styles.heading, { fontFamily: 'Times-Bold', }]}>MANIKANTA JEWELLERY</Text>
                                        ...
                                        <View style={styles.contentContainer}>
                                                ...
                                                <View style={styles.leftColumn}>
                                                        <Text style={styles.flatNo}> Keshavakrupa complex </Text>
                                                        <Text style={styles.cin}>Near chennakeshava swamy temple, Ramanuja rasthe </Text>
                                                        <Text style={styles.cin}>Town, Kote, Belur Karnataka - 573115.</Text>
                                                ...
                                                <View style={styles.rightColumn}>
                                                        ...
                                                        <Text style={styles.branchContent}>Keshavakrupa complex </Text>
                                                        <Text style={styles.branchContent}> Near chennakeshava swamy temple, Ramanuja rasthe</Text>
                                                        <Text style={styles.branchContent}>Town, Kote, Belur Karnataka - 573115.</Text>
                                                </View>
                                        </View>
                                        ...
                                        <View style={{ textAlign: 'center' }}>
                                                <Text>
                                                        Mob : 9535403545, EMAIL : manikantajewellers99@gmail.com
                                                </Text>
                                        </View>
                                        ...
                                        <View style={styles.boxContainer}>
                                                ...
                                                <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "space-between", marginBottom: 3, fontFamily: 'Times-Bold' }}>
                                                        ...
                                                        <View style={{ alignrepairDetailss: "flex-end", paddingRight: 10 }}>
                                                                <Text style={[styles.bold]}>For MANIKANTA JEWELLERY</Text>
                                                        </View>
